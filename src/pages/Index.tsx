...
const Index = () => {
  const { t } = useLanguage();
  const featuredProducts = mockProducts.slice(0, 6); // Show more products to enable carousel navigation
  
  // Hero slideshow images - using product images with Nordic feel
  const heroImages = [
            ...
            <div className="max-w-4xl mx-auto text-center text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link to="/products">
                  <Button 
                    size="lg" 
                    className="bg-white text-black hover:bg-white/90 font-semibold px-8 py-4 text-lg shadow-lg hover:shadow-xl transition-all duration-300"
                  >
                    Explore Collection
                  </Button>
                </Link>
