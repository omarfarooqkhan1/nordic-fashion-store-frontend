...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ...
    className={cn(
      ...
      "fixed z-[100] flex max-h-screen w-full flex-col-reverse p-4 left-1/2 -translate-x-1/2 bottom-2 top-auto sm:left-auto sm:translate-x-0 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col md:max-w-[420px]",
      className
    )}
    {...props}
  />
